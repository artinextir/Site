...
export const localRevitFamilyCreationTehran: Localized<HomeContent> = {
  fa: {
    meta: {
      title: "ساخت فمیلی رویت در تهران — آرتینکست",
      description:
        "ساخت و توسعه فمیلی اختصاصی رویت برای تولیدکنندگان، دفاتر معماری و تیم‌های MEP در تهران؛ محتوای BIM دقیق و سبک، هماهنگ با استاندارد واقعی محصول یا پروژه شما.",
    },
    breadcrumb: "ساخت فمیلی رویت تهران",
    hero: {
      eyebrow: "آرتینکست / تهران",
      headline: "تیم ما در تهران است؛ فمیلی رویت را از روی کاتالوگ واقعی شما می‌سازیم.",
      subhead:
        "ساخت، توسعه یا طراحی فمیلی رویت — هرچه صدایش کنید، برای تولیدکنندگان، دفاتر معماری و تیم‌های سازه و MEP در تهران، محتوای BIM دقیق و سبک می‌سازیم که با استاندارد واقعی محصول یا پروژه شما هماهنگ است، نه یک فمیلی عمومی دانلودی.",
      ctaPrimary: "شروع گفتگو",
      ctaSecondary: "مشاهده راهکارها",
      visualLabel: "فمیلی. رویت. تهران.",
      visualTag: "۳۵.۶۸۹۲° شمالی، ۵۱.۳۸۹۰° شرقی — تهران",
    },
    markers: [
      { title: "تیم مستقر در تهران", description: "دسترسی حضوری در تهران، در کنار همکاری کاملاً ریموت برای بقیه کشور." },
    ...
    statement: {
      ...
      headline: "دقیقاً از همان‌جایی شروع می‌کنیم که یک فمیلی عمومی، محصول یا پروژه تهرانی شما را درست طراحی نمی‌کند.",
      frictions: [
        {
    ...
    process: {
      heading: "چطور یک فمیلی رویت را برای تهران توسعه می‌دهیم",
      steps: [
        { title: "کشف", description: "کاتالوگ محصول یا استاندارد فعلی دفتر شما در تهران و نمونه فایل‌های موجود را بررسی می‌کنیم." },
  ...
  en: {
    meta: {
      ...
      description:
        "Custom Revit family creation for manufacturers, architecture, and MEP offices in Tehran — precise, lightweight BIM content built to your real project standard.",
    },
    breadcrumb: "Revit Family Creation, Tehran",
    hero: {
      eyebrow: "ARTINEXT / TEHRAN",
      headline: "Our team is in Tehran. We build the Revit family from your real catalog.",
      subhead:
        "Call it Revit family creation, development, or design — for manufacturers, architecture offices, and structural and MEP teams in Tehran, we build precise, lightweight BIM content matched to your actual product or project standard, not a generic downloaded family.",
      ctaPrimary: "Start a project",
      ctaSecondary: "Explore solutions",
      visualLabel: "FAMILY. REVIT. TEHRAN.",
      visualTag: "35.6892° N, 51.3890° E — Tehran",
    },
    markers: [
      { title: "Team based in Tehran", description: "On-the-ground access in Tehran, alongside fully remote collaboration for the rest of the country." },
    ...
    statement: {
      ...
      headline: "We start exactly where a generic family stops being good enough for your Tehran product or project.",
      frictions: [
        {
    ...
    process: {
      heading: "How we develop a Revit family for Tehran",
      steps: [
