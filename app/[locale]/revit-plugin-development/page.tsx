...
import { localRevitPluginDevelopment } from "@/content/local-revit-plugin-development";
...
const PATH = "/revit-plugin-development";
...
export async function generateMetadata({
  ...
  const c = localRevitPluginDevelopment[locale as Locale] ?? localRevitPluginDevelopment.fa;
...
export default async function RevitPluginDevelopmentPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localRevitPluginDevelopment[locale];
