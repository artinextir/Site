...
import { localRevitFamilyCreation } from "@/content/local-revit-family-creation";
...
const PATH = "/revit-family-creation";
...
export async function generateMetadata({
  ...
  const c = localRevitFamilyCreation[locale as Locale] ?? localRevitFamilyCreation.fa;
...
export default async function RevitFamilyCreationPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localRevitFamilyCreation[locale];
