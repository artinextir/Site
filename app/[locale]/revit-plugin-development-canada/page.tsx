...
import { localRevitPluginDevelopmentCanada } from "@/content/local-revit-plugin-development-canada";
...
const PATH = "/revit-plugin-development-canada";
...
export async function generateMetadata({
  ...
  const c = localRevitPluginDevelopmentCanada[locale as Locale] ?? localRevitPluginDevelopmentCanada.fa;
...
export default async function RevitPluginDevelopmentCanadaPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localRevitPluginDevelopmentCanada[locale];
