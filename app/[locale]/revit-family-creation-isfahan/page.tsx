...
import { localRevitFamilyCreationIsfahan } from "@/content/local-revit-family-creation-isfahan";
...
const PATH = "/revit-family-creation-isfahan";
...
export async function generateMetadata({
  ...
  const c = localRevitFamilyCreationIsfahan[locale as Locale] ?? localRevitFamilyCreationIsfahan.fa;
...
export default async function RevitFamilyCreationIsfahanPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localRevitFamilyCreationIsfahan[locale];
  ...
  const serviceSchema = {
    ...
    areaServed: { "@type": "City", name: "Isfahan" },
    url,
  };
