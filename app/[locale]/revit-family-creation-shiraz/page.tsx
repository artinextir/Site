...
import { localRevitFamilyCreationShiraz } from "@/content/local-revit-family-creation-shiraz";
...
const PATH = "/revit-family-creation-shiraz";
...
export async function generateMetadata({
  ...
  const c = localRevitFamilyCreationShiraz[locale as Locale] ?? localRevitFamilyCreationShiraz.fa;
...
export default async function RevitFamilyCreationShirazPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localRevitFamilyCreationShiraz[locale];
  ...
  const serviceSchema = {
    ...
    areaServed: { "@type": "City", name: "Shiraz" },
    url,
  };
