...
import { productRevitFamilies } from "@/content/product-revit-families";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: url, languages: hreflangAlternates("/products/revit-families") },
...
export default async function RevitFamiliesPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
            ...
            breadcrumbs={
              <Breadcrumbs
                ...
                items={[
                  ...
                  { label: c.breadcrumb, href: "/products/revit-families" },
                ]}
              />
            }
          />
