...
import { productAutomation } from "@/content/product-automation";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: url, languages: hreflangAlternates("/products/automation") },
            ...
            breadcrumbs={
              <Breadcrumbs
                ...
                items={[
                  ...
                  { label: c.breadcrumb, href: "/products/automation" },
                ]}
              />
            }
          />
