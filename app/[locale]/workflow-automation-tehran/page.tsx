...
import { localWorkflowAutomationTehran } from "@/content/local-workflow-automation-tehran";
...
const PATH = "/workflow-automation-tehran";
...
export async function generateMetadata({
  ...
  const c = localWorkflowAutomationTehran[locale as Locale] ?? localWorkflowAutomationTehran.fa;
...
export default async function WorkflowAutomationTehranPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localWorkflowAutomationTehran[locale];
