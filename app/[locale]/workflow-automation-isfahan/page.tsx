...
import { localWorkflowAutomationIsfahan } from "@/content/local-workflow-automation-isfahan";
...
const PATH = "/workflow-automation-isfahan";
...
export async function generateMetadata({
  ...
  const c = localWorkflowAutomationIsfahan[locale as Locale] ?? localWorkflowAutomationIsfahan.fa;
...
export default async function WorkflowAutomationIsfahanPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localWorkflowAutomationIsfahan[locale];
