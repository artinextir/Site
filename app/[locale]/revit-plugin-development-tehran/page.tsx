...
import { localRevitPluginDevelopmentTehran } from "@/content/local-revit-plugin-development-tehran";
...
const PATH = "/revit-plugin-development-tehran";
...
export default async function RevitPluginDevelopmentTehranPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
