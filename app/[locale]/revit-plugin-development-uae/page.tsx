...
import { localRevitPluginDevelopmentUae } from "@/content/local-revit-plugin-development-uae";
...
const PATH = "/revit-plugin-development-uae";
...
export async function generateMetadata({
  ...
  const c = localRevitPluginDevelopmentUae[locale as Locale] ?? localRevitPluginDevelopmentUae.fa;
...
export default async function RevitPluginDevelopmentUaePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localRevitPluginDevelopmentUae[locale];
