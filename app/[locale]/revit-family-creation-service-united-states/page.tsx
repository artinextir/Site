...
import { localRevitFamilyCreationServiceUnitedStates } from "@/content/local-revit-family-creation-service-united-states";
...
const PATH = "/revit-family-creation-service-united-states";
...
export default async function RevitFamilyCreationServiceUnitedStatesPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
