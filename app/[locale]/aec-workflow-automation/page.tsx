...
import { localAecWorkflowAutomation } from "@/content/local-aec-workflow-automation";
...
const PATH = "/aec-workflow-automation";
...
export async function generateMetadata({
  ...
  const c = localAecWorkflowAutomation[locale as Locale] ?? localAecWorkflowAutomation.fa;
...
export default async function AecWorkflowAutomationPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const c = localAecWorkflowAutomation[locale];
